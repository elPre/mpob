 ...
 */
public class HlsMediaSourceMute implements MediaSource,
    ...
    /** Factory for {@link HlsMediaSourceMute}s. */
    public static class Factory implements AdsMediaSource.MediaSourceFactory {
        ...
        /**
         * Returns a new {@link com.google.android.exoplayer2.source.hls.HlsMediaSource} using the current parameters. Media source events will
         * not be delivered.
         *
         * @return The new {@link com.google.android.exoplayer2.source.hls.HlsMediaSource}.
         */
        public HlsMediaSourceMute createMediaSource(Uri playlistUri) {
         ...
         */
        @Override
        public HlsMediaSourceMute createMediaSource(
                Uri playlistUri,
     ...
     *     not required.
     * @deprecated Use {@link com.google.android.exoplayer2.source.hls.HlsMediaSource.Factory} instead.
     */
    @Deprecated
    public HlsMediaSourceMute(
            Uri manifestUri,
     ...
     * @param dataSourceFactory An {@link HlsDataSourceFactory} for {@link DataSource}s for manifests,
     *     segments and keys.
     * @param extractorFactory An {@link com.google.android.exoplayer2.source.hls.HlsExtractorFactory} for {@link Extractor}s for the segments.
     * @param minLoadableRetryCount The minimum number of times loads must be retried before errors
     *     are propagated.
     * @param eventHandler A handler for events. May be null if delivery of events is not required.
     * @param eventListener A {@link MediaSourceEventListener}. May be null if delivery of events is
    ...
    public void onPrimaryPlaylistRefreshed(HlsMediaPlaylist playlist) {
        ...
        sourceListener.onSourceInfoRefreshed(this, timeline,
                new HlsManifestMute(playlistTracker.getMasterPlaylist(), playlist));
    }
