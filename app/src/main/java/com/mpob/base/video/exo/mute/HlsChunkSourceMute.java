 ...
 */
/* package */ class HlsChunkSourceMute {
   ...
   *     multiple {@link HlsChunkSourceMute}s are used for a single playback, they should all share the
   *     same provider.
   * @param muxedCaptionFormats List of muxed caption {@link Format}s. Null if no closed caption
   *     information is available in the master playlist.
   */
  public HlsChunkSourceMute(HlsExtractorFactory extractorFactory, HlsPlaylistTracker playlistTracker,
   ...
   */
  public void getNextChunk(HlsMediaChunkMute previous, long playbackPositionUs, long loadPositionUs,
                           HlsChunkHolder out) {
  ...
  /**
   * Called when the {@link HlsSampleStreamWrapperMute} has finished loading a chunk obtained from this
   * source.
   *
  ...
  /**
   * Called when the {@link HlsSampleStreamWrapperMute} encounters an error loading a chunk obtained
   * from this source.
   *
