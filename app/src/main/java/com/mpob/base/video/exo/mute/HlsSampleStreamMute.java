 ...
 */
/* package */ final class HlsSampleStreamMute implements SampleStream {

  private final int trackGroupIndex;
  private final HlsSampleStreamWrapperMute sampleStreamWrapper;
  private int sampleQueueIndex;

  public HlsSampleStreamMute(HlsSampleStreamWrapperMute sampleStreamWrapper, int trackGroupIndex) {
