 ...
 */
public class DefaultHlsExtractorFactoryMute implements HlsExtractorFactory {
    ...
    public Pair<Extractor, Boolean> createExtractor(Extractor previousExtractor, Uri uri,
        ...
        if (MimeTypes.TEXT_VTT.equals(format.sampleMimeType)
            ...
            extractor = null;//new WebvttExtractor(format.language, timestampAdjuster);
